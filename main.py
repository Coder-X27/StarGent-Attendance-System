...
if __name__=="__main__":
    ...
    speak("Welcome to the StarGent Robotics Community \n")
    ...
    if(choice==1 or choice==4):
        ...
        speak("Plz Place your Thumb on the scanner to know your identification\n")
        isValid=validation()
        if isValid is True:
            user=identify()
            if(user):
        ...
        speak('Hi There ! Here Our Motto is to Make Bots and TO make the Gyanni 3.0')